...
<div class="bg-light lter b-b wrapper-md">
  <h1 class="m-n font-thin h3">Update Success Stories</h1>
</div>
    ...
    <div class="col-sm-12">
      <div class="panel panel-default">
        ...
        <div class="panel-body">
          <form role="form" enctype="multipart/form-data" method="post" action="{{URL::to('Update-Stories')}}" >
          @csrf
          <input type="hidden" name="id" value="{{$data['id']}}">
            ...
            <div class="col-md-6 form-group">
              ...
              <select name="active" id="active" class="form-control">
                <option value="Yes" name="active" >Yes</option>
                <option value="No" name="active">No</option>
              </select>
            </div>
