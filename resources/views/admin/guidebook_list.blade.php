 ...
 <div id="content" class="app-content" role="main">
            <div class="app-content-body ">
                <div class="bg-light lter b-b wrapper-md">
                    <h1 class="m-n font-thin h3">List of Guide Book</h1>
                   
                </div>
                <div class="col-md-12 text-right"> <a class="btn btn-info" href="{{URL::to('booklet')}}">Add Guide Book</a></div>
              ...
              @endif
                        <div class="panel-heading">  List of Guide Book</div>
                                  ...
                                  @foreach($guidebook as $b)
                                        <tr>
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <li><a href="{{URL::to('/editbooklet/'.$b[0]->code)}}"  class="editbtn"><i class="fa fa-pencil-square-o text-info" aria-hidden="true"> Guide Book Edit</i></a></li>
