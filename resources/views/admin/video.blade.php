...
<div class="bg-light lter b-b wrapper-md">
  <h1 class="m-n font-thin h3">Add Video</h1>
</div>
    ...
    <div class="col-sm-12">
      <div class="panel panel-default">
        ...
        <div class="panel-body">
          <form role="form" enctype="multipart/form-data" method="post" action="{{URL::to('Save-Video')}}" >
          @csrf
            ...
            <div class="col-md-6 form-group">
              ...
              Yes :  <input type="radio" name="video_active" value="Yes" checked>
